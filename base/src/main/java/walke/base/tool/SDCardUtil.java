...
/**
 * Created by walke.Z on 2018/1/17.
 */

public class SDCardUtil {
    // 判断sd卡是否可用
    public static boolean isSdSafe() {
        /**
     ...
     * 3. 文件名称
     */
    public static void saveFile (String path,byte[] b,String fileName) {
     ...
     * 3. 复制文件的文件名称
     * */
    public static void copyFile(File source,String path,String fileName){
        try {
