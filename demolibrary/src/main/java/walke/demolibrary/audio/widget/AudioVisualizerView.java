...
import walke.demolibrary.audio.dao.AudioData;
import walke.demolibrary.audio.dao.FFTData;
import walke.demolibrary.audio.renderer.Renderer;
...
public class AudioVisualizerView extends View {
    ...
    public AudioVisualizerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        init();
    }
