...
public class ScrollLinearLayout4 extends LinearLayout {
    ...
    public ScrollLinearLayout4(Context context) {
        this(context, null);
    }

    public ScrollLinearLayout4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollLinearLayout4(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (v > 10 && CustomWebView.isTop) {//下拉
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (moveY > headerHeight && CustomWebView.isTop) {//下拉
