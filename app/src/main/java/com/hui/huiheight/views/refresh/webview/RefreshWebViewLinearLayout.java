...
public class RefreshWebViewLinearLayout extends LinearLayout {
    ...
    public RefreshWebViewLinearLayout(Context context) {
        this(context, null);
    }

    public RefreshWebViewLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RefreshWebViewLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
