...
public class RefreshGridView extends LinearLayout {
    ...
    public RefreshGridView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (v > 10 && CustomGridView.isTop) {//下拉
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (moveY > headerHeight && CustomGridView.isTop) {//下拉
    ...
    public void refreshComplete() {
        ...
        scroller.startScroll(0, scrollEnd, 0, headerHeight,1000);//+headerHeight
        postInvalidate();
        setState(STATE_ORIGINAL);
