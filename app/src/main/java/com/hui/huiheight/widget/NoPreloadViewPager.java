...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        ...
        if (oldWidth > 0) {
            ...
            if (!mScroller.isFinished()) {
                // We now icon_return to your regularly scheduled scroll, already in progress.
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
         ...
         * If we icon_return true, onMotionEvent will be called and we do the actual
         * scrolling there.
         */
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (activePointerId == INVALID_POINTER) {
                    // If we don't have a valid index, the touch down wasn't on content.
                    break;
                }
     ...
     * is already in progress, this method will icon_return false.
     *
...
//                    }
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
        ...
        // we addChange ourselves (if focusable) in all cases except for when we are
        ...
        if (
            ...
            // addChange all views in.  So we need to do the same thing View does.
            if (!isFocusable()) {
                return;
            }
