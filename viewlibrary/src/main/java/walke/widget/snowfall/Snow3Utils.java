...
//    private float[] mScaleFactors = new float[]{0.3f,0.4f,0.6f,0.8f,1f};
    ...
    public Snow3Utils(Context context){
        mContext = context;
    }
...
//                canvas.restoreToCount(save);
                ...
                mCamera.translate(snow.x, -snow.y, 0);// mY1: -50
...
//                int centerY = mBitmaps[snow.index].getHeight() / 2;
                ...
                mCamera.restore();
                canvas.drawBitmap(mBitmaps[snow.index], mMatrix,mPaint);// 画图由左上角开始
                canvas.restoreToCount(save);
            }
        }
        updateSnowFlake();
